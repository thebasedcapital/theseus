...
while pgrep -f "queue_panel.sh|backfill.sh|queue_exact.sh|queue_merge.sh|queue_gaps.sh|queue_ledger.sh|merge_probe.py|gguf_probe.py" >/dev/null; do sleep 30; done
